...
# Usage:
#   analyze.sh --watch [<source>|--source <source>] [--session <id>] [--all-sessions]  live dashboard
...
if [[ "$1" == "--watch" ]]; then
  ...
  exec python3 "$PLUGIN_DIR/visualize.py" $SOURCE_ARG $SESSION_ARG $ALL_SESSIONS_ARG
fi
